...
class NetworkConnectivityObserver(context: Context) {
    ...
    fun observe(): Flow<ConnectionStatus> = callbackFlow {
        ...
        trySend(if (isConnected) ConnectionStatus.Available else ConnectionStatus.Unavailable)
...
fun ConnectionStatus.isConnected(): Boolean = this == ConnectionStatus.Available
