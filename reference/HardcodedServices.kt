...
/**
 * Backup copy of the original bundled service catalogue.
 * This file is outside the app source set, so it is not compiled or shown in the app.
 * Firebase is the catalogue the app loads.
 */
internal val hardcodedServices: List<Service> = listOf(
